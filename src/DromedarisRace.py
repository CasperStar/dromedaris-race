...
GLOBAL_SENSOR_MAPPING = ( MicroSwitch(0, 1, 0x20,  0), MicroSwitch(0, 2, 0x20,  1), MicroSwitch(0, 3, 0x20,  2), # Track 1
                          MicroSwitch(1, 1, 0x20,  3), MicroSwitch(1, 2, 0x20,  4), MicroSwitch(1, 3, 0x20,  5)) # Track 2
                         #MicroSwitch(2, 1, 0x20,  8), MicroSwitch(2, 2, 0x20,  9), MicroSwitch(2, 3, 0x20, 10), # Track 3
                         #MicroSwitch(3, 1, 0x20, 11), MicroSwitch(3, 2, 0x20, 12), MicroSwitch(3, 3, 0x20, 13), # Track 4
